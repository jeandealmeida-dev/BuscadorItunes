...
import com.jeanpaulo.musiclibrary.player.R
import com.jeanpaulo.musiclibrary.player.databinding.FullPlayerBottomSheetBinding
...
class FullPlayerBottomSheet(
    ...
    fun updatePlayer(song: MPSong, hasNext: Boolean, hasPrevious: Boolean) {
        binding.apply {
